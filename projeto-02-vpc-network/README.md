...
1. Criação de uma VPC (Virtual Private Cloud) para isolamento da rede.
2. Configuração de sub-redes para segmentação dos recursos.
3. Definição e aplicação de regras de segurança através de Security Groups.
